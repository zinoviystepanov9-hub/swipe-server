...
// GET /api/users/search?q=текст — ВАЖНО: этот роут должен идти раньше /:id,
// иначе Express примет "search" за значение параметра :id
...
// GET /api/users/:id — публичный профиль пользователя по id (для уведомлений и просмотра профиля)
